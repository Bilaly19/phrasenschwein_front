            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <Button
                        ...
                        class="!border-0 !p-0 !min-w-5 !w-5 !h-5 !rounded-full outline-none outline-offset-1"
                        text
                        rounded
                        aria-label="Primaerfarbe auswaehlen"
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <Button
                        ...
                        text
                        rounded
                        aria-label="Oberflaechenfarbe auswaehlen"
                        class="!border-0 !p-0 !min-w-5 !w-5 !h-5 !rounded-full outline-none outline-offset-1"
